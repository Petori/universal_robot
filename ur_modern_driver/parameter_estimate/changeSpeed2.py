...
def main():
    ...
    try:
        ...
        child1 = subprocess.Popen('rostopic echo /joint_states >changespeed2.txt',shell=True)
        move()
        print "Trajectory finished"
        time.sleep(0.5)
        child2 = subprocess.Popen('cp changespeed2.txt data/changespeed2.txt',shell=True)
        time.sleep(0.5)
        child3 = subprocess.Popen('rm changespeed2.txt',shell=True)
        time.sleep(0.5)
        if True:
            child1.kill()
            child2.kill()
