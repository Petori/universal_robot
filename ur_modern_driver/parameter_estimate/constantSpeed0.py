...
Q4 = [1.5,-1.57,0,-1.57,0,0]
Q5 = [2,-1.57,0,-1.57,0,0]
Q6 = [2.5,-1.57,0,-1.57,0,0]
...
def main():
    ...
    try:
        ...
        child1 = subprocess.Popen('rostopic echo /joint_states >constantspeed0.txt',shell=True)
        move()
        print "Trajectory finished"
        time.sleep(0.5)
        child2 = subprocess.Popen('cp constantspeed0.txt data/constantspeed0.txt',shell=True)
        time.sleep(0.5)
        child3 = subprocess.Popen('rm constantspeed0.txt',shell=True)
        time.sleep(0.5)
        if True:
            child1.kill()
            child2.kill()
