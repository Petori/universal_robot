...
Q1 = [3,-1.57,0,-1.57,0,0]
Q2 = [0,-1.57,0,-1.57,0,0]
Q3 = [-3,-1.57,0,-1.57,0,0]
Q4 = [0,-1.57,0,-1.57,0,0]
Q5 = [3,-1.57,0,-1.57,0,0]
...
def main():
    ...
    try:
        ...
        child1 = subprocess.Popen('rostopic echo /joint_states >changespeed0.txt',shell=True)
        move()
        print "Trajectory finished"
        time.sleep(0.5)
        child2 = subprocess.Popen('cp changespeed0.txt data/changespeed0.txt',shell=True)
        time.sleep(0.5)
        child3 = subprocess.Popen('rm changespeed0.txt',shell=True)
        time.sleep(0.5)
        if True:
            child1.kill()
            child2.kill()
